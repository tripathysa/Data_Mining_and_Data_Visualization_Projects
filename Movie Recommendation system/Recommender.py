#Author: Saurabh Tripathy
#EMAIL id : saurtrip@indiana.edu

#Program is an attempt to build a recommender system for movies based on k nearest neighbors classification algorithms.
#Inputs are hardcoded in the program.Please change the parameters to suit your test.
...
#Reading files and creating appropriate dictionaries
...
#FIrst part of problem is in If condition and part b of the problem is in else part
        if algo=='parta':
...
#Predict the ratings of movies in test file:
...
# Main function. We can change program parameters here like the training file, test file, distance metric to be chosen etc.
